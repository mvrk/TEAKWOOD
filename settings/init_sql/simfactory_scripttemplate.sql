...
(9, 6, 2, 'export WINE=/usr/bin/wine\r\nexport EFDC=/home/simulocean/efdc/efdc.exe', 'date', '$WINE  $EFDC  > $WORK_DIR/simulocean.out 2> $WORK_DIR/simulocean.err', '', '', '', '');
