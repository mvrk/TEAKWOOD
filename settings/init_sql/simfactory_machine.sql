...
(1, 'Queen Bee', 1, 1, '2013-03-18 07:23:37', '2013-03-18 10:46:01', 'The large LONI Linux cluster', 'qb.loni.org', 'alex', 1, 2, 4, 1, 8, 256, 2048, 72, 8172892, 25165812, 'other_os', '2.6.9-78.0.22.EL_lustre.1.6.7.2_loni', 'x64', 'LONI, LSU', 'http://hpc.loni.org/resources/hpc/system.php?system=QueenBee', 'sys-help@loni.org', '/work/alex', 'workq', 'loni_ngchc_2013', 'TEAKWOOD', 'localhost:8000', '/data/TEAKWOOD', '/home/alex/tools/rsync/bin/rsync', '-rLptgoD --chmod=Dugo+x --chmod=ugo+r', 1, 'TEAKWOOD', 'localhost:8000', '/data/simulocean', '/data/klhu/viz/d3d_field_view.sh', 0),
