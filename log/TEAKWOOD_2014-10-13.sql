...
INSERT INTO `simfactory_machine` VALUES (1,'Queen Bee',1,1,'2014-09-18 07:23:37','2014-09-18 10:46:01','The large LONI Linux cluster','qb.loni.org','alex',1,2,4,1,8,256,2048,72,8172892,25165812,'other_os','2.6.9-78.0.22.EL_lustre.1.6.7.2_loni','x64','LONI, LSU','http://hpc.loni.org/resources/hpc/system.php?system=QueenBee','sys-help@loni.org','/work/alex','workq','loni_ngchc_2013','TEAKWOOD','localhost:8000','/data/TEAKWOOD','/home/alex/tools/rsync/bin/rsync','-rLptgoD --chmod=Dugo+x --chmod=ugo+r',1,'TEAKWOOD','localhost:8000','/data/teakwood','/data/klhu/viz/d3d_field_view.sh',0),(2,'Teakwood',1,1,'2014-09-18 07:23:37','2014-09-18 10:46:01','A virtual machine ','localhost:8000','teakwood',1,2,2,1,4,1,4,100000,2051316,4128764,'linux','3.6.11-1.fc17.x86_64','x64','CCT, LSU','http://localhost:8000','guojiarui@gmail.com','/data/teakwood','batch','','teakwood','localhost:8000','/data/teakwood','rsync','-rLptgoD --chmod=Dugo+x --chmod=ugo+r',1,'','','','',0),(3,'localhost',1,1,'2014-09-18 07:23:37','2014-09-18 10:46:01','Alex\'s personal laptop','localhost.localdomain','alex',1,1,4,2,4,1,8,100000,16388144,0,'linux','3.6.11-1.fc17.x86_64','x64','CCT, LSU','http://localhost:8000','guojiarui@gmail.com','/var/www/html/Teakwood/media/simulations','batch','','teakwood','localhost:8000','/data/teakwood','rsync','-rLptgoD --chmod=Dugo+x --chmod=ugo+r',1,'','','','',0),(4,'SuperMike-II',1,2,'2014-09-18 20:13:21','2014-09-18 21:06:58','LSU HPC\'s largest Dell cluster','mike.hpc.lsu.edu','rguo',1,2,8,1,16,382,6112,72,32836256,100663288,'linux','2.6.32-279.19.1.el6.x86_64','x64','HPC, LSU','http://www.hpc.lsu.edu/resources/hpc/system.php','sys-help@loni.org','/work/alex','checkpt','hpc_charcol','teakwood','localhost:8000','/data/teakwood','rsync','-rLptgoD --chmod=Dugo+x --chmod=ugo+r',1,'teakwood','localhost:8000','/data/teakwood','/data/klhu/viz/d3d_field_view.sh',0);
